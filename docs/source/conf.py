...
# -*- coding: utf-8 -*-
#
# ndx-nonrigid-motion-correction documentation build configuration file, created by
# sphinx-quickstart on Sat Jul 13 11:28:50 2019.
#
...
project = 'ndx-nonrigid-motion-correction'
...
htmlhelp_basename = 'ndx-nonrigid-motion-correctiondoc'
...
latex_documents = [
    (master_doc, 'ndx-nonrigid-motion-correction.tex', 'ndx-nonrigid-motion-correction Documentation',
     'Ben Dichter', 'manual'),
]
...
man_pages = [
    (master_doc, 'ndx-nonrigid-motion-correction', 'ndx-nonrigid-motion-correction Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ndx-nonrigid-motion-correction', 'ndx-nonrigid-motion-correction Documentation',
     author, 'ndx-nonrigid-motion-correction', 'One line description of project.',
     'Miscellaneous'),
]
