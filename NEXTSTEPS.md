# Next Steps for ndx-nonrigid-motion-correction Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-nonrigid-motion-correction directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-nonrigid-motion-correction` - Folder with the sources of the NWB extension
        - `ndx-nonrigid-motion-correction/__init__.py` - Python file that may be empty
...
`spec/ndx-nonrigid-motion-correction.namespace.yaml` and
`spec/ndx-nonrigid-motion-correction.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-nonrigid-motion-correction
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/bendichter/ndx-nonrigid-motion-correction/releases/tag/0.1.0

9. Publish your updated extension on PyPi.
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-nonrigid-motion-correction/0.1.0
...
`staged-extensions/ndx-nonrigid-motion-correction`:

    ```bash
cp -r staged-extensions/example staged-extensions/ndx-nonrigid-motion-correction
```

11. Edit `staged-extensions/ndx-nonrigid-motion-correction/ndx-meta.yaml`
...
version: 0.1.0
src: https://github.com/bendichter/ndx-nonrigid-motion-correction
pip: https://pypi.org/project/ndx-nonrigid-motion-correction/
license: BSD 3-Clause
maintainers:
  - bendichter
```

12. Edit `staged-extensions/ndx-nonrigid-motion-correction/README.md`
to add information about your extension. You may copy it from
`ndx-nonrigid-motion-correction/README.md`.

  ```bash
cp ndx-nonrigid-motion-correction/README.md staged-extensions/ndx-nonrigid-motion-correction/README.md
```
...
ndx-nonrigid-motion-correction-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-nonrigid-motion-correction GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-nonrigid-motion-correction-feedstock repository on GitHub.
